    ...
    "data": [
        {
            ...
            "description": "Test",
            "avatar": null,
            "created_at": "2022-07-01T03:46:03.000000Z",
            "updated_at": "2022-07-01T05:23:05.000000Z"
        },
        {
            "id": 2,
            "name": "Java",
            ...
            "description": "Test",
            "avatar": null,
            "created_at": "2022-07-01T03:46:24.000000Z",
            "updated_at": "2022-07-01T05:24:34.000000Z"
        },
        {
            "id": 3,
            "name": "Python",
            ...
            "description": "Test",
            "avatar": null,
            "created_at": "2022-07-01T03:46:30.000000Z",
            "updated_at": "2022-07-01T05:09:46.000000Z"
        }
    ],
...
```bash
curl -X GET \
    -G "http://localhost/api/products/eligendi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/products/eligendi"
);
...
```bash
curl -X GET \
    -G "http://localhost/api/cart/magni" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X DELETE \
    "http://localhost/api/cart/aperiam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
